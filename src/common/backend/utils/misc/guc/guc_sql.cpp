...
static void InitSqlConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_partitionwise",
            ...
            NULL,
            NULL},
        {{"enable_cstore_partition_lane_scan",
            PGC_USERSET,
            NODE_ALL,
            QUERY_TUNING_METHOD,
            gettext_noop("Assigns each CStore table partition to one SMP scan lane."),
            NULL},
            &u_sess->attr.attr_sql.enable_cstore_partition_lane_scan,
            false,
            NULL,
            NULL,
            NULL},
